...
export function DynamicDialog({
  ...
  return (
    <ResponsiveDialog open={dialogOpen} onOpenChange={handleOpenChange}>
      ...
      <ResponsiveDialogContent className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl p-0 gap-0">
        <AnimatePresence mode="wait">
          {dialogOpen && (
            ...
            >
              <ResponsiveDialogHeader className="px-6 pt-6 pb-2 space-y-0 flex-shrink-0">
              ...
              {variant === "confirmation" && (
                <motion.div
                  ...
                  className="flex flex-col-reverse sm:flex-row sm:justify-end gap-2 px-6 py-3 flex-shrink-0"
                >
                  <Button
                    variant="outline"
                    onClick={handleCancel}
                    size="sm"
                    className="w-full sm:w-auto min-w-[100px] text-sm font-medium"
                  >
                    {cancelText}
                  </Button>
                  <Button
                    ...
                    size="sm"
                    className={cn(
                      "w-full sm:w-auto min-w-[100px] text-sm font-medium text-white",
